...
export function Sidebar({
  ...
  const content = (
    <aside className="w-[min(86vw,288px)] lg:w-[216px] h-[100dvh] bg-[#111720] dark:bg-[#080b16] text-[#e3e1ec] flex flex-col border-r border-white/8 select-none mobile-safe-bottom">
      {/* Brand Header */}
      <div className="h-14 px-3 flex items-center justify-between border-b border-white/8">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 bg-[#0785ad] rounded-lg flex items-center justify-center text-white font-bold">
