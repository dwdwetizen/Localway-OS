...
export function AdminView({ onShowToast }: AdminViewProps) {
  ...
  return <div className="space-y-6 animate-in fade-in duration-300">
    ...
    {activeTab === 'integracoes' && <section className="bg-white dark:bg-[#141936] p-6 rounded-2xl border"><Settings className="text-[#0066ff]"/><h3 className="font-bold mt-3">Integrações</h3><p className="text-xs text-[#727687]">As chaves ficam nas variáveis seguras da Vercel.</p></section>}
  </div>;
